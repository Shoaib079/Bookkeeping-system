...
| Automated tests | ✅ **4331 passing, 9 skipped, 2 xfailed** (run `pytest tests/` on host) |
...
**Test baseline:** `pytest tests/` — **4331 passed**, 9 skipped, 2 xfailed.
...
6. **P3.9** — retire `migrate_schema()` implementation (phased); **P3.9-A ✅** · **P3.9-B-CHAR ✅** · **P3.9-B ✅**; next **P3.9-C** (removal).
...
| [ALEMBIC-01](#alembic-01) | Alembic replaces `migrate_schema()` | 🟡 Partial — L-EXEC/L-TESTS/N ✅ · P3.9-A/B-CHAR/B ✅; P3.9-C next |
...
**Next slices:** ~~MD-02~~ ✅ · ~~MD-03~~ ✅ · ~~MD-04-CHAR~~ ✅ · ~~MD-04a~~ ✅ · ~~MD-04b~~ ✅ → **MD-04c+** kernel Decimal math → MD-05 Alembic Numeric (PG test)
...
**Status:** 🟡 **Partial** — P3.8-K2 wired; **P3.8-L-EXEC ✅** · **P3.8-L-TESTS ✅** · **P3.8-N ✅** · **P3.9-A ✅** · **P3.9-B-CHAR ✅** · **P3.9-B ✅**; **`migrate_schema()` deprecated, retained** — P3.9-C next
...
**Completed slices:** P3.8-K2 startup wiring · P3.8-L bake-in review plan · P3.8-M local smoke · **P3.8-L-EXEC** · **P3.8-L-TESTS** · **P3.8-N** default flip · **P3.9-A** retirement readiness audit · **P3.9-B-CHAR** caller inventory · **P3.9-B** deprecation warning.

**Next slices:** **P3.9-C** (removal after warning-clean window).

**Docs:** [P3_8_L_BAKEIN_AUDIT.md](./docs/P3_8_L_BAKEIN_AUDIT.md) · [P3_8_L_BAKEIN_EXEC.md](./docs/P3_8_L_BAKEIN_EXEC.md) · [P3_8_L_TESTS.md](./docs/P3_8_L_TESTS.md) · [P3_8_N_DEFAULT_FLIP.md](./docs/P3_8_N_DEFAULT_FLIP.md) · [P3_9_A_AUDIT.md](./docs/P3_9_A_AUDIT.md) · [P3_9_B_CHAR_MIGRATE_SCHEMA_CALLERS.md](./docs/P3_9_B_CHAR_MIGRATE_SCHEMA_CALLERS.md) · [P3_9_B_DEPRECATION.md](./docs/P3_9_B_DEPRECATION.md) · contracts: `test_p3_8_k2_startup_wiring.py` · `test_p3_8_l_exec_bakein_execution.py` · `test_p3_8_l_tests_bakein_characterization.py` · `test_p3_8_n_default_flip.py` · `test_p3_9_a_audit.py` · `test_p3_9_b_char_migrate_schema_callers.py` · `test_p3_9_b_deprecation.py`
