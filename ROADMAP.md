...
| **FASTAPI-REACT-11+** | Void/purchase write UI | 📋 Planned |

**Audit:** [FASTAPI_REACT_10_REACT_WRITE_PAYMENT_METHODS_AUDIT.md](./docs/FASTAPI_REACT_10_REACT_WRITE_PAYMENT_METHODS_AUDIT.md) · **Tests:** `tests/test_fastapi_react_10_react_write_payment_methods.py` · **Tag:** `fastapi-react-10-react-write-payment-methods`

**Next slice:** **FASTAPI-REACT-11** — void or purchase write tab; see FR-10 audit §8.
