...
| **NAV-ARCH** — Navigation single source of truth | 🟡 **S3B complete** — role gates derived; S3C–S4 planned — see [§ NAV-ARCH](#nav-arch--navigation-single-source-of-truth) |
...
**Status:** 🟡 **In progress — S3B complete**  
