...
| **ALEMBIC-01** | Alembic revision chain replaces incremental `migrate_schema()` | Medium | **Partial** — P3.8-K2 wired; **L-EXEC/L-TESTS/N ✅** · **P3.9-A/B-CHAR ✅**; P3.9-B next | [P3_9_B_CHAR_MIGRATE_SCHEMA_CALLERS.md](./P3_9_B_CHAR_MIGRATE_SCHEMA_CALLERS.md); PG cutover blocker |
...
5. **P3.9** — phased `migrate_schema()` retirement (**P3.8-L-EXEC ✅** · **P3.8-L-TESTS ✅** · **P3.8-N ✅** · **P3.9-A ✅** · **P3.9-B-CHAR ✅** → P3.9-B → P3.9-C)
