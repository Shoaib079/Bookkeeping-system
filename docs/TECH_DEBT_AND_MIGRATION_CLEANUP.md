...
7. **PostgreSQL build + dual-run parity** — Alembic head incl. `0002` on PG test DB; production cutover still blocked
8. **React migration** — not started (`ERP_DS_05` spec only)
