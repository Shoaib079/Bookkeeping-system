...
| **ALEMBIC-01** | Alembic revision chain replaces incremental `migrate_schema()` | Medium | **Partial** — P3.8-K2 wired; **L-EXEC/L-TESTS/N ✅**; P3.9 next | [P3_8_N_DEFAULT_FLIP.md](./P3_8_N_DEFAULT_FLIP.md); PG cutover blocker |
...
5. **P3.9** — phased `migrate_schema()` retirement (**P3.8-L-EXEC ✅** · **P3.8-L-TESTS ✅** · **P3.8-N ✅**)
