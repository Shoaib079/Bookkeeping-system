...
| **ALEMBIC-01** | Alembic revision chain replaces incremental `migrate_schema()` | Medium | **Partial** — P3.8-K2 wired; **L-EXEC/L-TESTS/N ✅** · **P3.9-A/B-CHAR/B ✅**; P3.9-C next | [P3_9_B_DEPRECATION.md](./P3_9_B_DEPRECATION.md); PG cutover blocker |
