...
| **ALEMBIC-01** | Alembic revision chain replaces incremental `migrate_schema()` | Medium | **Partial** — P3.8-K2 wired; **L-EXEC/L-TESTS/N ✅** · **P3.9-A ✅**; P3.9-B-CHAR next | [P3_9_A_AUDIT.md](./P3_9_A_AUDIT.md); PG cutover blocker |
