...
| **TD-DSC-07** | **Roadmap / docs drift** — keep DSC phase status current in `ROADMAP.md` and spec §10 as P2–P4 land | Low | Open | DSC-P2 complete 2026-06-05; spec §10 still pending sync |
