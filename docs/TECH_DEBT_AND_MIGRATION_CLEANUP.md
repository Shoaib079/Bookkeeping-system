...
| **MONEY-DECIMAL-01** | `Float` → `Decimal` for money fields across models and services | High | **MD-05-IMPL-1 ✅** · **MD-05-IMPL-2 ✅** · **MD-05-IMPL-3 ✅** — quantization + cache re-sync; IMPL-4..5 pending | [MONEY_DECIMAL_05_NUMERIC_MIGRATION_PLAN.md](./MONEY_DECIMAL_05_NUMERIC_MIGRATION_PLAN.md); PG **production** blocked |
...
4. **MONEY-DECIMAL-05-IMPL-4..5** — migration smoke + cutover readiness (**IMPL-1 ✅** · **IMPL-2 ✅** · **IMPL-3 ✅** quantization + cache re-sync)
