...
- **MONO-THEME-01-S2 — token refinements:** add **shared component-grammar tokens** by reference (`--erp-nav-active-*`, `--erp-card-*`, `--erp-chip-*`) — no new colors; extend the token-parity test.
