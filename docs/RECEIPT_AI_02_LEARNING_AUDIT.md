...
- **RECEIPT-AI-02-IMPL-5 — surface suggestions in capture UI:** ✅ learned prefill in Receipt Capture — see [RECEIPT_AI_02_IMPL_5.md](./RECEIPT_AI_02_IMPL_5.md). User still reviews; no auto-post.
