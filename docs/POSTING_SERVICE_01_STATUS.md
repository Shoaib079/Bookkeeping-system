...
|------|-------|
| Branch | `main` |
| Latest commit | `e0c2fff` — Characterize reconciliation posting boundary |
| Working tree | Clean |
| Test suite | **1881 passed**, **2 xfailed** |

Recent commits:

```
e0c2fff Characterize reconciliation posting boundary
c34db84 Move fiscal close posting to service
f2adde9 Characterize fiscal close posting behavior
52f1dd8 Move profit allocation posting to service
```
...
## PS-P7 — Deferred Hardening Debt

Do not start before dedicated PS-P7 characterization.
