...
|---|---|---|
| **Primary router** | `_PAGE_DISPATCH` dict → `render_*` per `nav_selection` — **derived from `registry/navigation.py`** | `25971`; dispatch call `26242` |
| **Desktop sidebar render** | `_render_navigation_tree(st.sidebar, …)` (custom button accordion) | def `3185`; call `26199` |
| **`st.sidebar` usage (only 2 sites)** | date-range filters; nav tree | `1008-1009`, `26199` |
