...
export function VendorsPage() {
  ...
  const [page, setPage] = useState<VendorsListResponse | null>(null);
  ...
  return (
    <section className="erp-vendors-page">
      <header className="erp-page-header">
        <h1>Vendors</h1>
        <p className="erp-page-header__meta">Read-only vendor list via `/api/v1/vendors`</p>
      </header>
      ...
      {page ? (
        <>
          <div className="erp-ledger-summary">
            <span>Vendors: {page.row_count}</span>
          </div>
