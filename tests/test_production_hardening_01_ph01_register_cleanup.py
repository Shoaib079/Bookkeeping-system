...
def test_active_pages_deferred_points_at_ph03():
    assert "PRODUCTION-HARDENING-03" in pages_contract.DEFERRED_ITEMS


def test_active_write_deferred_points_at_ph03():
    assert "PRODUCTION-HARDENING-03" in write_contract.DEFERRED_ITEMS
