...
from sqlalchemy import Column, Integer, String, Float, Numeric, Date, DateTime, Boolean, ForeignKey, Text, UniqueConstraint
from sqlalchemy.orm import relationship

# MD-05-IMPL-2 — money column types (matches Alembic 0002 / money_numeric_columns.py)
NUMERIC_MONEY = Numeric(19, 2, asdecimal=True)
NUMERIC_FX = Numeric(19, 4, asdecimal=True)
NUMERIC_RATE = Numeric(19, 8, asdecimal=True)
...
class ChartOfAccounts(Base):
    ...
    balance = Column(NUMERIC_MONEY, default=Decimal("0.00"))
    is_active = Column(Boolean, default=True)
...
class JournalEntryLine(Base):
    ...
    debit = Column(NUMERIC_MONEY, default=Decimal("0.00"))
    credit = Column(NUMERIC_MONEY, default=Decimal("0.00"))
    currency = Column(String(10), nullable=True)      # transaction currency (e.g. "USD")
    amount_native = Column(NUMERIC_FX, nullable=True)      # debit-credit net in reporting currency
    company_id = Column(Integer, nullable=True)       # Phase 14A
...
class CashSale(Base):
    ...
    amount = Column(NUMERIC_MONEY, nullable=False)
...
class Sale(Base):
    ...
    paid_amount = Column(NUMERIC_MONEY, default=Decimal("0.00"))
    balance = Column(NUMERIC_MONEY, default=Decimal("0.00"))
    ...
    fx_rate       = Column(NUMERIC_RATE,       default=Decimal("1.00000000"))
    native_amount = Column(NUMERIC_FX,       nullable=True)
    company_id    = Column(Integer,     nullable=True)  # Phase 14A
...
class ExpenseRecord(Base):
    ...
    gross_salary = Column(NUMERIC_MONEY, default=Decimal("0.00"))
    deductions = Column(NUMERIC_MONEY, default=Decimal("0.00"))
    net_salary = Column(NUMERIC_MONEY, default=Decimal("0.00"))
    is_void = Column(Boolean, default=False, index=True)
    voided_at = Column(Date, nullable=True)
    void_reason = Column(Text, nullable=True)
    tx_category_id = Column(Integer, nullable=True)
...
class Payable(Base):
    ...
    amount = Column(NUMERIC_MONEY, nullable=False)
    paid_amount = Column(NUMERIC_MONEY, default=Decimal("0.00"))
    balance = Column(NUMERIC_MONEY, nullable=True)
...
class Product(Base):
    ...
    cost_price = Column(NUMERIC_MONEY, default=Decimal("0.00"))
    unit_price = Column(NUMERIC_MONEY, default=Decimal("0.00"))
...
class Budget(Base):
    ...
    amount      = Column(NUMERIC_MONEY, nullable=False, default=Decimal("0.00"))
    notes       = Column(Text, nullable=True)
    company_id  = Column(Integer, nullable=True)      # Phase 14A
...
class DailyCashReconciliation(Base):
    ...
    opening_cash        = Column(NUMERIC_MONEY, nullable=True)
    expected_cash       = Column(NUMERIC_MONEY, nullable=False)
    actual_cash         = Column(NUMERIC_MONEY, nullable=False)
    difference          = Column(NUMERIC_MONEY, nullable=False)
...
class EndOfDayClose(Base):
    ...
    notes                 = Column(Text, nullable=True)
    cash_sales            = Column(NUMERIC_MONEY, nullable=False, default=Decimal("0.00"))
    card_sales            = Column(NUMERIC_MONEY, nullable=False, default=Decimal("0.00"))
    credit_sales          = Column(NUMERIC_MONEY, nullable=False, default=Decimal("0.00"))
    total_sales           = Column(NUMERIC_MONEY, nullable=False, default=Decimal("0.00"))
    total_expenses        = Column(NUMERIC_MONEY, nullable=False, default=Decimal("0.00"))
    total_purchases       = Column(NUMERIC_MONEY, nullable=False, default=Decimal("0.00"))
    customer_payments     = Column(NUMERIC_MONEY, nullable=False, default=Decimal("0.00"))
    supplier_payments     = Column(NUMERIC_MONEY, nullable=False, default=Decimal("0.00"))
    bank_deposits         = Column(NUMERIC_MONEY, nullable=False, default=Decimal("0.00"))
    bank_withdrawals      = Column(NUMERIC_MONEY, nullable=False, default=Decimal("0.00"))
    net_cash_movement     = Column(NUMERIC_MONEY, nullable=False, default=Decimal("0.00"))
    daily_profit_estimate = Column(NUMERIC_MONEY, nullable=False, default=Decimal("0.00"))
    recon_status          = Column(String(50), nullable=True)
    recon_variance        = Column(NUMERIC_MONEY, nullable=True, default=Decimal("0.00"))
...
class ExternalSalesVerification(Base):
    ...
    external_total        = Column(NUMERIC_MONEY, nullable=True)
    z_report_total        = Column(NUMERIC_MONEY, nullable=True)
    external_cash         = Column(NUMERIC_MONEY, nullable=True)
    external_card         = Column(NUMERIC_MONEY, nullable=True)
    external_online       = Column(NUMERIC_MONEY, nullable=True)
    erp_total             = Column(NUMERIC_MONEY, nullable=True)
    erp_cash              = Column(NUMERIC_MONEY, nullable=True)
    erp_card              = Column(NUMERIC_MONEY, nullable=True)
    erp_credit            = Column(NUMERIC_MONEY, nullable=True)
    variance_total        = Column(NUMERIC_MONEY, nullable=True)
    variance_cash         = Column(NUMERIC_MONEY, nullable=True)
    variance_card         = Column(NUMERIC_MONEY, nullable=True)
    variance_online       = Column(NUMERIC_MONEY, nullable=True)
    z_report_variance     = Column(NUMERIC_MONEY, nullable=True)
...
class PartnerProfitAllocation(Base):
    ...
    total_net_income    = Column(NUMERIC_MONEY, nullable=False)
    journal_entry_id    = Column(Integer, ForeignKey("journal_entries.id"), nullable=True)
    notes               = Column(Text, nullable=True)
    is_void             = Column(Boolean, default=False, index=True)
    voided_by_id        = Column(Integer, ForeignKey("users.id"), nullable=True)
...
class YearEndClose(Base):
    ...
    net_income_snapshot         = Column(NUMERIC_MONEY, nullable=False)
    re_balance_at_close         = Column(NUMERIC_MONEY, nullable=False)
...
class BankStatementImport(Base):
    ...
    starting_balance = Column(NUMERIC_MONEY, nullable=True)
    ending_balance = Column(NUMERIC_MONEY, nullable=True)
...
class BankStatementRow(Base):
    ...
    debit_amount = Column(NUMERIC_MONEY, nullable=True)
    credit_amount = Column(NUMERIC_MONEY, nullable=True)
    amount = Column(NUMERIC_MONEY, nullable=False, default=Decimal("0.00"))
    balance_after = Column(NUMERIC_MONEY, nullable=True)
    currency = Column(String(10), nullable=False)
    original_amount = Column(NUMERIC_MONEY, nullable=False, default=Decimal("0.00"))
...
class SettlementStatementRow(Base):
    ...
    gross_amount = Column(NUMERIC_MONEY, nullable=False, default=Decimal("0.00"))
    fee_amount = Column(NUMERIC_MONEY, nullable=False, default=Decimal("0.00"))
    net_amount = Column(NUMERIC_MONEY, nullable=False, default=Decimal("0.00"))
    currency = Column(String(10), nullable=False)
...
class Worker(Base):
    ...
    base_salary = Column(NUMERIC_MONEY, nullable=True)
    is_active = Column(Boolean, default=True, index=True)
    notes = Column(Text, nullable=True)
    created_at = Column(DateTime, nullable=False)
...
class WorkerMovement(Base):
    ...
    gross_salary = Column(NUMERIC_MONEY, default=Decimal("0.00"))
    deductions = Column(NUMERIC_MONEY, default=Decimal("0.00"))
    advance_recovery = Column(NUMERIC_MONEY, default=Decimal("0.00"))
    net_paid = Column(NUMERIC_MONEY, default=Decimal("0.00"))
    journal_entry_id = Column(Integer, ForeignKey("journal_entries.id"), nullable=True)
    bank_transaction_id = Column(Integer, ForeignKey("bank_transactions.id"), nullable=True)
    notes = Column(Text, nullable=True)
    is_void = Column(Boolean, default=False, index=True)
...
class Ingredient(Base):
    ...
    cost_per_base_unit = Column(NUMERIC_FX, nullable=False, default=Decimal("0.0000"))
    is_active = Column(Boolean, default=True, index=True)
    notes = Column(Text, nullable=True)
    created_by_id = Column(Integer, ForeignKey("users.id"), nullable=True)
    created_at = Column(DateTime, nullable=False)
...
class MenuPriceHistory(Base):
    ...
    price_gross = Column(NUMERIC_MONEY, nullable=False)
